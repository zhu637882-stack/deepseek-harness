...
New automatic preparation uses the [shared execution authoring](2026-09-15-qingmu-shared-execution-prompt.md) decision; the copying behavior described here remains available to legacy callers and manual editing.
