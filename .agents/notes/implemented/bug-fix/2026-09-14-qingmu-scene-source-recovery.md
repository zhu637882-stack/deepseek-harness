# Episode design source recovery

An episode creative session can reread complete saved shots after compaction through the existing scene-planning command. One shot per page avoids duplicating the canonical and editable projections while preserving exact creative text. Scope comes from the consumed project request; the tool does not grant shot-edit authority.
