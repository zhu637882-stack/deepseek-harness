...
Initial assembly follows the selected Take source by exact frame, original asset and SHA. Unselected candidates require an explicit local editorial choice. Saved cuts keep their own sources and trims; a later Take choice does not overwrite an edit. This prevents generation order from overriding shooting decisions.
