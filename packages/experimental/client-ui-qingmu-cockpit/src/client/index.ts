...
export function apply(ctx: ClientContext): void {
  ...
  const port: QingmuYimengPort = {
    ...
    readLocalVideoSource: (request, signal) => command('readLocalVideoSource', request, signal),
    registerLocalVideoSource: (request, signal) => command('registerLocalVideoSource', request, signal),
    recoverLocalVideoSource: (request, signal) => command('recoverLocalVideoSource', request, signal),
    ...
    reviewWorkingCutSound: (request, signal) => command('reviewWorkingCutSound', request, signal),
    ...
    generateAssetImage: (request, signal) => command('generateAssetImage', request, signal),
    readAssetImageRuns: (request, signal) => command('readAssetImageRuns', request, signal),
    readAssetVoiceRuns: (request, signal) => command('readAssetVoiceRuns', request, signal),
    quoteAssetVoice: (request, signal) => command('quoteAssetVoice', request, signal),
    generateAssetVoice: (request, signal) => command('generateAssetVoice', request, signal),
    ...
    readStyleComposition: (request, signal) => command('readStyleComposition', request, signal),
    ...
    queueReferenceVideo: (request, signal) => command<ReferenceVideoRun>('queueReferenceVideo', request, signal),
    ...
    referenceVideoQuote: (request, signal) => read<ReferenceVideoQuoteResponse>('referenceVideoQuote', request, signal),
    referenceVideoDraft: (request, signal) => read<ReferenceVideoDraftResponse>('referenceVideoDraft', request, signal),
    saveReferenceVideoDraft: (request, signal) => command<ReferenceVideoDraftResponse>('saveReferenceVideoDraft', request, signal),
    ...
    createTakeComment: (request, signal) =>
