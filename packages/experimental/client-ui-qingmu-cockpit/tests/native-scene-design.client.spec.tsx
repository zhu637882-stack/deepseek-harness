...
const shots = [{ title: '邀请', narrative: '允许接近', visual: '门内望向来客', action: '主人让出通道', durationSec: 6,
  dialogueLineIds: ['line1'], directorPlan: { selfContainedImagePrompt: true,
    actionBeats: [{ beatId: 'wait', type: 'performance', startSec: 0, endSec: 2, visualResponsibility: '主人看向门外来客，先停顿。' },
      { beatId: 'invite', type: 'performance', startSec: 2, endSec: 6, visualResponsibility: '说完邀请后侧身让出通道，仍留在门内。' }],
    editorialContext: '下段接窗外雨声', coveragePlan: '本段先中景后切近景', cameraMovement: '跟随后停稳', soundPlan: { ambience: '雨声持续' },
