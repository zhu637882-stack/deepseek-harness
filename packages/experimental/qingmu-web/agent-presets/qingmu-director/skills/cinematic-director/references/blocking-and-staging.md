...
| Multiple characters speaking with visible lip-sync | Verify the current route | Preserve scripted turns and directed coverage; check individual voice/mouth ownership and timing using [sound-and-dialogue.md](sound-and-dialogue.md) |
...
2. Specify every performer's timed movement or deliberate hold from the blocking plan; coordinate simultaneous movement and contact explicitly.
