...
| P4 | 20 | Prompt hygiene | The five-question self-check in [video prompt template](video-prompt-template.md) passes on every prompt: complete directed action and camera sequence, explicit end state, invariants present, negatives matched to real risk. Duration fits the actual performance and verified target capabilities; no fixed action, movement, speaker or word count is an acceptance rule |
