 ...
 * @returns a handler for private element, reference-asset, and PromptIR method endpoints.
 */
export function createImagoMethodHandler(
  ...
  return async (endpoint, payload, signal) => {
    try {
      if (endpoint !== 'elementMethod' && endpoint !== 'referenceAssetMethod' && endpoint !== 'promptIrMethod') {
