...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  qingmuYimengCommand: 'interface-typed private Host handler (ConnectionRpcHandler), reused by the Qingmu director context bridge — packages/experimental/qingmu-director-context-bridge/README.md owns the API',
